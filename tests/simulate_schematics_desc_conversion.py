...
"""
Simulate Schematics Text (schematics_desc) conversion on the latest output run.

Actions:
1) Clean ONLY output/[UNIQUE]/schematics_desc
2) Invoke scripts/schematics_text_converter.py with input=lowlevel and output=schematics_desc
"""
...
def main() -> int:
    ...
    out_dir = latest / "schematics_desc"
    converter = repo_root / "scripts" / "schematics_text_converter.py"
    ...
    print("=" * 80)
    print("SCHEMATICS TEXT (schematics_desc) CONVERTER RUNNER")
    print("=" * 80)
